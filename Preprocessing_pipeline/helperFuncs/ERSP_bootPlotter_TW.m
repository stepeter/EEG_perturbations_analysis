function ERSP_bootPlotter(STUDY,ALLEEG,tlim,flim,clim,clusters,cond_labels,savePlots,savePath,basetime,evPlotLines,erspNums)
...
%         end
        ...
        ylimits = ylim; %(gca);
        set(gca,'YTick',log([4.01,8,13,30,50,80,99.4843]));%100-.05])); %4.009255933
        if k==1
