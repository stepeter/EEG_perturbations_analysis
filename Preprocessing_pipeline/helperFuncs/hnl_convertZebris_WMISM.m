function [finalelocs]=hnl_convertZebris_WMISM(ELocs_rawfile,ELocs_file,standardcapelocs,collectionsys,numChans,ElecFolder)
...
if ~exist([ELocs_file(1:(length(ELocs_file)-4)) '_final.sfp'])
    ...
    if plo ==1
        ...
        saveas(gcf,[ElecFolder 'DigitizedElecLocs'],'fig');
    end
