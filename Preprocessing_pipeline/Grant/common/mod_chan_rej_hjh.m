function [ICA_STRUCT, chan_rej_log] = mod_chan_rej_hjh(EEG,good_chans)
...
%SP 08-21-15 - added topoplots of percent ranks to manual rejection case
...
while ~finish_chan_rej
    ...
    switch method
        ...
        case 'Manually'
            ...
            %Added modified topoplots of percent ranks for manual rejection
            weights=[eye(4);[1 1 1 1]];
            titles={'Correlation Percent Rank','Standard Deviation Percent Rank','Kurtosis Percent Rank','Range Percent Rank','Combined Percent Rank'};
            for i=1:5
                figure;
                mod_topoplot_ranks([],EEG.chanlocs, 'style', 'blank',  'electrodes', 'labelpoint', 'chaninfo', EEG.chaninfo,'weights',weights(i,:),'eegdata',EEG,'titles',titles{1,i});
            end
