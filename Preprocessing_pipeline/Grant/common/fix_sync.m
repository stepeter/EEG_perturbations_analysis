...
function [new_eeg_trig_latencies new_csv_trig_latencies EEG new_biomech] = fix_sync(EEG, csv_filename,csv_data, csv_sync_ch_idx, csv_sample_rate)

eeg_trig_latencies = cell2mat(get_EEG_event_array(EEG,32776,'latency'));
eeg_trig_event= cell2mat(get_EEG_event_array(EEG,32776,'urevent'));
